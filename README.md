...
## 📌 Overview
This project presents an AI-driven system designed to monitor aircraft turnaround activities in real time and predict operational delays at an activity level. By leveraging computer vision and predictive analytics, the system enhances airport ground operation efficiency, safety, and decision-making.

The solution focuses on detecting key turnaround activities from video feeds, estimating their durations, and predicting potential delays before they propagate into flight schedule disruptions.
